...
- [x] Tag the resulting stable milestone after remote verification and a clean build/test run. After the pre-publication [history rewrite](history-rewrite.md), the annotated tag is `extended-workflow-baseline` on rewritten commit `5dd8d2`.
