...
| --- | ---: | --- | --- |
| `invalid_document_upload` | `400` | Upload field, usually `image`, `images`, or `form` | The request was not multipart, did not include the required image field, exceeded per-file or capture aggregate size limits, included too many capture files, or used an unsupported content type or extension. |
