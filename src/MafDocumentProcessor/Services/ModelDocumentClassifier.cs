        ...
        var response = await chatClient.CompleteAsync(
            new ModelChatRequest(
                ...
                [
                    ...
                    {"category":"Receipt|Invoice|ShoppingList|SujikoPuzzle|ExpenseReport|Unknown","confidence":0.0,"documentTypeDescription":"short human document type","confidenceReasoning":"short reason"}
                    ...
                    Use ExpenseReport for employee expense reports or expense claim forms that list claimed totals and expense lines. Do not classify a multi-line expense claim form as a Receipt.
                    Use Unknown when the image is not clearly a receipt, invoice, shopping list, Sujiko puzzle, or expense report. If it is another recognizable type, name it in documentTypeDescription, for example "car registration document".
                    """),
